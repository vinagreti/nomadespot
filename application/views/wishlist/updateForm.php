...
<p><small>Preencha o formulário abaixo e clique em "Salvar" para editar este desejo.</small></p>

<form id="wishlistUpdateForm" method="PATCH" class="form-horizontal" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <input id="country_typeahead" name="country_name" type="text" class="form-control" placeholder="Digite o nome do país" autocomplete="off">
...
<script type="text/javascript">
    ...
    nsp_wishlist.triggerUpdateForm();
