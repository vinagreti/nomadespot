...
<p><small>Preencha o formulário abaixo e clique em "Salvar" para editar esta inspiração.</small></p>

<form id="inspirationsUpdateForm" method="PATCH" class="form-horizontal" role="form">
...
<script type="text/javascript">
    ...
    nsp_inspirations.triggerUpdateForm();
