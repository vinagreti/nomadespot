...
<p><small>Preencha o formulário abaixo e clique em "Salvar" para adicionar uma tarefa.</small></p>

<form id="todoUpdateForm" method="POST" class="form-horizontal" role="form">

    <div class="form-group">
        <label for="title" class="col-sm-2 control-label">Título</label>
        <div class="col-sm-22">
            <input id="title" name="title" type="text" class="form-control" placeholder="Digite o título da tarefa">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-22">
            <textarea id="desc" name="desc" class="form-control" placeholder="Descreva da tarefa"></textarea>
        </div>
    </div>
    ...
    <div class="form-group">
        <label for="country_typeahead" class="col-sm-2 control-label">Responsável</label>
        <div class="col-sm-10">
            <input id="user_typeahead" type="text" class="form-control" placeholder="Digite o nome do responsável" autocomplete="off">
